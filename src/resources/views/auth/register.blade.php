                ...
                >
                    ...
                    <div>
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
                            <button
                                    class="inline-flex items-center justify-center cursor-pointer gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10"
                            >
                                <svg
                                        width="20"
                                        height="20"
                  ...
                  >
                        ...
                        >
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    <button
                                       class="flex items-center justify-center cursor-pointer w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-blue-500 shadow-theme-xs hover:bg-blue-600"
                                    >
                                        Sign Up
                                    </button>
                                </div>
                        ...
                        <div class="mt-5">
                            ...
                            >
                                ...
                                <a
                                        href="/signin.html"
                                        class="text-blue-500 hover:text-brand-600 dark:text-brand-400"
                                >Sign In</a
                                >
                            </p>
                        </div>
