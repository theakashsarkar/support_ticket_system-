            ...
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                ...
                >
                    <div>
                        <div>
                            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
                                <button
                                        class="inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10 cursor-pointer"
                                >
                                    <svg
                                            width="20"
                                            height="20"
                    ...
                    >
                            ...
                            <form x-data="{ email = '', password = ''}" method="POST" action="{{ 'login' }}">
                                @csrf
                                <div class="space-y-5">
                                    <!-- Email -->
                                    <div>
                          ...
                          >
                            ...
                            <div class="mt-5">
                                ...
                                >
                                    ...
                                    <a
                                            href="/signup.html"
                                            class="text-blue-500 hover:text-brand-600 dark:text-blue-400"
                                    >Sign Up</a
                                    >
                                </p>
                            </div>
